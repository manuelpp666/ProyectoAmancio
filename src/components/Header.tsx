        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <a className="bg-[#093E7A] text-white px-6 py-2.5 rounded-full font-bold text-sm uppercase tracking-wider hover:bg-[#073365] transition-all shadow-lg shadow-[#093E7A]/20" href="/campus">Campus Virtual</a>
            </div>
