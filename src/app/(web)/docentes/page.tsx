...
// Revalidación cada 60s (ISR). Se elimina el 'force-dynamic' anterior porque
// entraba en conflicto con el revalidate de los fetch.
export const revalidate = 60;

export const metadata: Metadata = {
  title: "Docentes | Amancio Varona",
  description: "Conoce a la plana docente del Colegio Amancio Varona.",
};
...
export default async function Page() {
  ...
  return (
    <div className="antialiased bg-white text-slate-800">
      {/* Hero Section */}
      <section className="relative py-24 md:py-28 overflow-hidden bg-gradient-to-br from-[#701C32] via-[#701C32] to-[#093E7A]">
      ...
      <section className="py-16 md:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          {docentesActivos.length > 0 && (
            <p className="text-center text-sm font-bold text-slate-400 uppercase tracking-widest mb-10 md:mb-12">
