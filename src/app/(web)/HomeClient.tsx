  ...
  return (
    <>
      ...
      <section className="relative min-h-[560px] md:min-h-[660px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute -top-24 -left-24 w-72 h-72 md:w-96 md:h-96 bg-white/10 rounded-full blur-3xl z-0"></div>
        <div className="absolute -bottom-32 -right-20 w-80 h-80 md:w-[28rem] md:h-[28rem] bg-[#093E7A]/40 rounded-full blur-3xl z-0"></div>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-white mb-6 leading-tight drop-shadow-lg">
            {getVal('hero_titulo', "Formando líderes para el futuro")}
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-10 font-light max-w-2xl mx-auto">
        ...
        <section className="py-16 md:py-24 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl md:text-4xl font-black text-[#701C32] mb-4">Propuesta Educativa</h2>
              <div className="w-24 h-1.5 bg-[#701C32] mx-auto rounded-full"></div>
            </div>

            <div className="relative">
              <div className="bg-[#FFF1E3] rounded-[2rem] md:rounded-[3rem] p-6 sm:p-8 md:p-16 flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-inner border border-white min-h-[450px]">
                <div className="w-full md:w-1/2 flex justify-center">
                  <div key={currentSlide} className="relative w-48 h-48 sm:w-64 sm:h-64 bg-white rounded-full flex items-center justify-center shadow-2xl animate-fadeIn border-8 border-[#f8ebdd]">
                    <RenderIcon name={propuestas[currentSlide].icon} size={120} className="text-[#701C32] w-24 h-24 sm:w-[140px] sm:h-[140px]" />
                    <div className="absolute -top-2 -right-2 w-16 h-16 sm:w-20 sm:h-20 bg-[#093E7A] rounded-2xl flex items-center justify-center text-white rotate-12 shadow-lg border-4 border-white">
                      <RenderIcon name={propuestas[currentSlide].badge} size={30} />
                    </div>
                  </div>
                </div>

                <div className="w-full md:w-1/2 text-center md:text-left">
                  <h3 className="text-2xl sm:text-3xl font-black text-[#701C32] mb-4 sm:mb-6">
                    {propuestas[currentSlide].titulo}
                  </h3>
                  <p className="text-base sm:text-lg text-slate-700 leading-relaxed mb-8 md:min-h-[120px]">
      ...
      <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#701C32] mt-2 mb-4">Nuestra metodología</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {niveles.map((nivel: any, idx: number) => (
              <div key={idx} className="group relative bg-white p-6 sm:p-8 rounded-[2rem] shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-slate-100 overflow-hidden">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-[#093E7A] mb-4">{nivel.titulo}</h3>
      ...
      <section className="py-16 md:py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-[#701C32] mb-4">Noticias Amancistas</h2>
          ...
          {noticias.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {noticias.map((noticia) => (
                <article key={noticia.id_noticia} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 flex flex-col">
                  ...
                  <div className="p-6 sm:p-8 flex flex-col flex-grow">
                    ...
                    <h4 className="text-lg sm:text-xl font-black text-slate-900 mb-4 leading-tight line-clamp-2">
                      {noticia.titulo}
                    </h4>
