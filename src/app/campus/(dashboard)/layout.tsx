...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const renderSidebar = () => {
    // 3. Normalizamos la detección del rol
    ...
    if (pathname.includes("/campus-auxiliar")) currentRole = "AUXILIAR";
    ...
    switch (currentRole) {
      ...
      case "AUXILIAR":
        return <SidebarAuxiliar isOpen={isMobileMenuOpen} onClose={() => setIsMobileMenuOpen(false)} />;
      default:
